...
(function () {
  ...
  const ENEMIES = [
    ...
    { id: 'soleimani', name: 'סולימאני', org: 'משמרות המהפכה', quip: 'סולק. שוב. הפעם בעלה.', weight: 7, points: 120,
    ...
    { id: 'haman', name: 'המן הרשע', org: 'פרס · מגילת אסתר', quip: 'סולק. הפעם בלי אוזניים.', weight: 3, points: 250, bonus: true,
